...
| `showCaptions`         | `true`  | Add a caption to each image with the contents of the title attribute, when this is not empty. Set this option to false to disable this behavior.                                                                                                                                                                                                                                                                                       |
